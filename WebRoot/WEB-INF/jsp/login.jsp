...
<html>
  ...
  <body>
  		...
  		<div id="center">
  			<img id="img" src="indeximg/loginbk.jpg">
  			<div id="box">
  				<p id="p1">密码登录</p>
  				<p id="p2"><c:if test="${warning != null}"><%=warning %></c:if></p>
  				<form action="/bookstore/findUsernameAndPassword.action" method="post" id="form">
    				<div id="user"><img src="indeximg/user.jpg"><input type="text" name="username" placeholder="输入密码" value="${sessionScpoe.u.username}"></div>
  					<div id="pass"><img src="indeximg/pass.jpg"><input type="text" name="password" value="${sessionScope.u.password}"></div>
  					<div id="randomNum"><img src="/bookstore/getImg.action"><input type="text" name="randomNum" placeholder="输入验证码"></div>
  					<input type="submit" value="登录" id="login">
    			</form> 				
  				<a id="register" href="/bookstore/register.action">免费注册</a>
  			</div>
  		</div>
    	<div id="footer">
    		<div id="box">
